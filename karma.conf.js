...
module.exports = function (config) {
	config.set({
		...
		files: [
			...
			'app/modules/profile/profileModule.js',
			'app/modules/profile/profileCtrl.js',
			'app/modules/profile/profileRoute.js',
			'app/modules/profile/profileService.js',
			'app/modules/profile/profile-test.js',
			'app/modules/connexion/connexionModule.js',
			'app/modules/connexion/connexionCtrl.js',
			'app/modules/connexion/connexionRoute.js',
			'app/modules/connexion/connexionService.js',
			'app/modules/connexion/connexion-test.js',
		],
